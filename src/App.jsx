        ...
        <div>
          ...
          <div className="interactive-card bg-white dark:bg-neutral-800/50 p-6 rounded-lg border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="flex justify-between items-baseline mt-4">
              ...
              <span className="font-bold text-green-800 dark:text-white bg-green-100 dark:bg-green-500/10 dark:text-green-400 px-2 py-1 rounded-md text-sm">
                CGPA: {education.cgpa}
              </span>
            </div>
          </div>
    ...
    <Section id="resume">
      <div className="text-center bg-white dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 rounded-lg p-12 float-animation">
        ...
        <p className="text-neutral-500 text-xs mt-4">
          Note: To make this link work, please place your resume file named
          "Pavan D .pdf" in the `public` folder of your React project.
        </p>
      </div>
    </Section>
  );
